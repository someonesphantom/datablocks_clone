                        ...
                        <React.Fragment>
                            <CardContent>
                                ...
                                <select onChange={(event) => { handleChange(event) }} style={{ marginLeft: 5, paddingRight: 24, paddingLeft: 6, fontFamily: 'inherit', width: 150, height: 30, background: "inherit", color: "inherit" }} >
                                    ...
                                    <option style={{ backgroundColor: "#4c497e" }} value={"xlsxtocsv"}>{"csv"}</option>
                                    <option style={{ backgroundColor: "#4c497e" }} value={"xlsxtoxml"}>{"xml"}</option>
                                    <option style={{ backgroundColor: "#4c497e" }} value={"xlsxtojson"}>{"json"}</option>
                                </select>
                                <br />
                                <br />
