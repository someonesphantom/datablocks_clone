                        ...
                        <React.Fragment>
                            <CardContent>
                                ...
                                <select onChange={(event) => { handleChange(event) }} style={{ marginLeft: 5, paddingRight: 24, paddingLeft: 6, fontFamily: 'inherit', width: 150, height: 30, background: "inherit", color: "inherit" }} >
                                    ...
                                    <option style={{ backgroundColor: "#4c497e" }} value={"jsontocsv"}>{"csv"}</option>
                                    <option style={{ backgroundColor: "#4c497e" }} value={"jsontoxml"}>{"xml"}</option>
                                    <option style={{ backgroundColor: "#4c497e" }} value={"jsontoxlsx"}>{"xlsx"}</option>
                                </select>
                                <br />
                                <br />
